    ...
    <xsl:template match="ROW">
        ...
        <xsl:element name="item">
            ...
            <xsl:element name="body">                
                <xsl:element name="entity">Q<xsl:value-of select="./QID"/></xsl:element>                
                <xsl:element name="property">P7</xsl:element>                
                <xsl:element name="value">https://thesaurus.cerl.org/record/<xsl:value-of select="./a15aa"/></xsl:element>                    
            </xsl:element>
        </xsl:element>
        </xsl:if>
    </xsl:template>
